...
public class IcebergKafkaMetricsReporter implements MetricsReporter {
  public static final String ICEBERG_EXPERIMENTAL_KAFKA_PREFIX_KEY =
      "iceberg.metrics.reporter.kafka.";
  ...
  private static final Logger LOG = LoggerFactory.getLogger(IcebergKafkaMetricsReporter.class);
  private Producer<String, String> producer;
  private String topic;

  /**
   * Default constructor for IcebergKafkaMetricsReporter. This constructor is intended for use when
   * the producer is set later via the initialize method.
   */
  public IcebergKafkaMetricsReporter() {}

  IcebergKafkaMetricsReporter(Producer<String, String> producer) {
    this(producer, ICEBERG_EXPERIMENTAL_KAFKA_TOPIC_DEFAULT);
  }

  IcebergKafkaMetricsReporter(Producer<String, String> producer, String topic) {
